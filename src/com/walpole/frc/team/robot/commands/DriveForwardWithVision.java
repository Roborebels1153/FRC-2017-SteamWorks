...
public class DriveForwardWithVision extends Command {
	//Drive
    ...
    public DriveForwardWithVision(double inchesToDrive, double speed, int errorTolerance, int errorOffset ) {
	requires(Robot.drive);
	//Drive
	this.speed = speed;
	this.setPoint = Constants.ticksPerInch * inchesToDrive; //this line alone = original
	SmartDashboard.putNumber("Inches to Drive (without vision distance)", inchesToDrive);
    ...
    public DriveForwardWithVision(double inchesToDrive, double speed, double secondsToDrive, int errorTolerance, int errorOffset) {
	requires(Robot.drive);
	//Drive
	this.speed = speed;
