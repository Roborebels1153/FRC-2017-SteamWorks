...
//	shooterMotor2 = new Victor(RobotMap.SHOOTER_MOTOR_TWO);
	...
	// RobotMap.SHOOTER_ENCODER2, false, Encoder.EncodingType.k4X);
	...
	// if (shooterEncoder.getRate() >= getPIDController().getSetpoint() - 50
	// && shooterEncoder.getRate() <= getPIDController().getSetpoint() + 50)
	// {
	// agitator.set(1);
	// } else {
	// agitator.set(0);
